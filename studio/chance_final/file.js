...
var responses11 = ['One of the worst feelings in the world is when you realize you weren’t really paranoid after all.', 'Worrying works! 90% of the things I worry about never happen.', 'An accident can take it all.', 'I will drink to your health, share your wealth, run your life, steal your wife.', 'I like your smile, but I am not your type, do not shake the tree when its fruit is not ripe.']
...
var responses20 = ['Paramedics finished her text, “…love you.”', 'It’s not the fall that kills you; it’s the sudden stop at the end.', 'Ice cream is good for the soul sometimes.', 'We are so concerned about what others are doing that we do not do anything ourselves.', 'Time and tide wait for no one.']
